...
// ============================================================
//  Drag-to-scroll on creative tracker table
// ============================================================
function initDragScroll() {
  var el = document.querySelector('.creatives-table-wrap');
  if (!el) return;
  var isDown = false;
  var startX;
  var scrollLeft;
  ...
  el.addEventListener('mousedown', function(e) {
    // Only drag on the scrollbar area or empty space, not on inputs
...
if (document.readyState === 'loading') {
  ...
  initDragScroll();
  // Re-init when creative tracker tab is clicked
  document.addEventListener('click', function(e) {
    if (e.target && e.target.classList &&
        (e.target.textContent || '').includes('CREATIVE TRACKER')) {
